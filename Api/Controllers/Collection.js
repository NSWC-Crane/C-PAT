...
module.exports.getCollectionAssetLabel = async function getCollectionAssetLabel(req, res, next) {
    try {
        const getCollection = await collectionService.getCollectionAssetLabel(req, res, next);
        if (getCollection) {
            res.status(200).json(getCollection);
        } else {
            res.status(204).send();
...
module.exports.getCollectionPoamLabel = async function getCollectionPoamLabel(req, res, next) {
    try {
        const getCollection = await collectionService.getCollectionPoamLabel(req, res, next);
        if (getCollection) {
            res.status(200).json(getCollection);
        } else {
            res.status(204).send();
...
module.exports.getCollectionPoamStatus = async function getCollectionPoamStatus(req, res, next) {
    try {
        const getCollection = await collectionService.getCollectionPoamStatus(req, res, next);
        if (getCollection && getCollection.poamStatus) {
            res.status(200).json(getCollection);
        } else {
            res.status(204).send();
        }
...
module.exports.getCollectionPoamSeverity = async function getCollectionPoamSeverity(req, res, next) {
    try {
        const getCollection = await collectionService.getCollectionPoamSeverity(req, res, next);
        if (getCollection && getCollection.poamSeverity) {
            res.status(200).json(getCollection);
        } else {
            res.status(204).send();
        }
...
module.exports.getCollectionPoamEstimatedCompletion = async function getCollectionPoamEstimatedCompletion(req, res, next) {
    try {
        const getCollection = await collectionService.getCollectionPoamEstimatedCompletion(req, res, next);
        if (getCollection && getCollection.poamEstimatedCompletion) {
            res.status(200).json(getCollection);
        } else {
            res.status(204).send();
        }
