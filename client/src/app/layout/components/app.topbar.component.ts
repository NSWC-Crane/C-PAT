...
import { Component, DOCUMENT, ElementRef, Inject, Input, OnDestroy, OnInit, Renderer2, afterNextRender, booleanAttribute, computed, inject } from '@angular/core';
    ...
    template: `<div class="layout-topbar">
        <div class="layout-topbar-inner">
            <div class="layout-topbar-logo-container">
                    ...
                    <svg width="170" height="50" viewBox="0 0 170 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                <stop offset="18%" style="stop-color:var(--high-contrast-text-color); stop-opacity: 0.5" />
                ...
                <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" class="layout-topbar-icon">
                    <defs>
...
export class AppTopBarComponent implements OnInit, OnDestroy {
    ...
    private setupNotifications(): void {
        const navigationEvents$ = this.router.events.pipe(filter((event): event is NavigationEnd => event instanceof NavigationEnd));
