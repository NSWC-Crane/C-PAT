...
export class UsersService {
  ...
  async deletePermission(userId: any, collectionId: any) {
        const headers = await this.getAuthHeaders();
		return this.http
      .delete<any>(`${this.cpatApiBase}/permission/${userId}/${collectionId}?elevate=true`, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  async updatePermission(userPermission: any) {
        const headers = await this.getAuthHeaders();
		return this.http
      .put<any>(`${this.cpatApiBase}/permission?elevate=true`, userPermission, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  async updateUser(userData: any) {
        const headers = await this.getAuthHeaders();
		return this.http
      .put<Users>(`${this.cpatApiBase}/user?elevate=true`, userData, { headers })
      .pipe(catchError(this.handleError));
  }
