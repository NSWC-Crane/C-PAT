...
export class UsersService {
  ...
  getUser(id: number): Observable<Users> {
    return this.http
      .get<Users>(`${this.cpatApiBase}/user/${id}?elevate=true`)
      .pipe(catchError(this.handleError));
  }

  getCurrentUser(): Observable<Users> {
    return this.http
      .get<Users>(`${this.cpatApiBase}/user`)
      .pipe(catchError(this.handleError));
  }

  getUsers(): Observable<Users[]> {
    return this.http
      .get<Users[]>(`${this.cpatApiBase}/users?elevate=true`)
      .pipe(catchError(this.handleError));
  }
  ...
  postPermission(userPermission: any): Observable<any> {
    return this.http
      .post<any>(`${this.cpatApiBase}/permission?elevate=true`, userPermission)
      .pipe(catchError(this.handleError));
  }
  ...
  updateUserPoints(userPointsData: any): Observable<Users> {
    return this.http
      .put<Users>(`${this.cpatApiBase}/user/updatePoints?elevate=true`, userPointsData)
      .pipe(catchError(this.handleError));
  }
  ...
  postTeamAssignment(assignedTeam: any): Observable<any> {
    return this.http
      .post<any>(`${this.cpatApiBase}/user/teams?elevate=true`, assignedTeam)
      .pipe(catchError(this.handleError));
  }
