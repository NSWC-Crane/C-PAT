...
export class ImportService {
  ...
  postTenableAnalysis(analysisParams: any): Observable<any> {
    return this.http.post(`${this.cpatApiBase}/tenable/analysis`, analysisParams).pipe(catchError(this.handleError));
  }
  ...
  getTenablePlugin(pluginId: any): Observable<any> {
    return this.http.get(`${this.cpatApiBase}/tenable/plugin/${pluginId}`).pipe(catchError(this.handleError));
  }

  getTenableAssetsFilter(): Observable<any> {
    return this.http.get(`${this.cpatApiBase}/tenable/asset?filter=excludeWatchlists,excludeAllDefined,usable&fields=name`).pipe(catchError(this.handleError));
  }

  getTenableAuditFileFilter(): Observable<any> {
    return this.http.get(`${this.cpatApiBase}/tenable/auditFile?filter=usable&fields=name`).pipe(catchError(this.handleError));
  }

  getTenableScanPolicyPluginsFilter(): Observable<any> {
    return this.http.get(`${this.cpatApiBase}/tenable/policy?filter=usable&fields=name`).pipe(catchError(this.handleError));
  }

  getTenableUsersFilter(): Observable<any> {
    return this.http.get(`${this.cpatApiBase}/tenable/user?fields=name,username,firstname,lastname`).pipe(catchError(this.handleError));
  }

  getTenablePluginFamily(): Observable<any> {
    return this.http.get(`${this.cpatApiBase}/tenable/pluginFamily?fields=name`).pipe(catchError(this.handleError));
  }

  getTenableRepositories(): Observable<any> {
    return this.http.get(`${this.cpatApiBase}/tenable/repository`).pipe(catchError(this.handleError));
  }

  postTenableSolutions(solutionParams: any): Observable<any> {
    return this.http.post(`${this.cpatApiBase}/tenable/solutions`, solutionParams).pipe(catchError(this.handleError));
  }

  postTenableSolutionAssets(solutionParams: any, solutionId: number): Observable<any> {
    return this.http.post(`${this.cpatApiBase}/tenable/solutions/${solutionId}/asset`, solutionParams).pipe(catchError(this.handleError));
  }

  postTenableSolutionVuln(solutionParams: any, solutionId: number): Observable<any> {
    return this.http.post(`${this.cpatApiBase}/tenable/solutions/${solutionId}/vuln`, solutionParams).pipe(catchError(this.handleError));
  }
