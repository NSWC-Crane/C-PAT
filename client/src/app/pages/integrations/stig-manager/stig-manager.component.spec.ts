...
describe('STIGManagerComponent', () => {
  let component: STIGManagerComponent;
  let fixture: ComponentFixture<STIGManagerComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideComponent(STIGManagerComponent, {
        set: {
          imports: [
            ButtonModule,
            CardModule,
    ...
    fixture = TestBed.createComponent(STIGManagerComponent);
