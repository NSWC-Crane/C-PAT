...
describe('TenableSolutionsComponent', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('should call getSolutions when matching collection is found', () => {
      ...
      mockCollectionsService.getCollectionBasicList.mockReturnValue(of(mockCollections));
      component.ngOnInit();
      expect(mockIntegrationService.postTenableSolutions).toHaveBeenCalled();
    });
    ...
    it('should not call getSolutions when no matching collection found', () => {
      ...
      mockCollectionsService.getCollectionBasicList.mockReturnValue(of(mockCollections));
      component.ngOnInit();
      expect(mockIntegrationService.postTenableSolutions).not.toHaveBeenCalled();
    });
  ...
  describe('getSolutions', () => {
    it('should call postTenableSolutions with correct params structure', () => {
      ...
      expect(mockIntegrationService.postTenableSolutions).toHaveBeenCalledWith(
    ...
    it('should include tenableRepoId in filter params', () => {
      component.tenableRepoId = '42';
      component.getSolutions();
      const callArg = mockIntegrationService.postTenableSolutions.mock.calls[0][0];
    ...
    it('should set loadingSolutions to true before request', () => {
      ...
      mockIntegrationService.postTenableSolutions.mockReturnValue(of(mockSolutionsResponse));
      component.getSolutions();
    ...
    it('should call messageService.add on error', () => {
      mockIntegrationService.postTenableSolutions.mockReturnValue(throwError(() => new Error('API error')));
      component.getSolutions();
  ...
  describe('getAffectedHosts', () => {
    ...
    it('should call getVulnDetails with parsed solutionId', () => {
      component.getAffectedHosts(mockSolution);
      expect(mockIntegrationService.postTenableSolutionVuln).toHaveBeenCalledWith(expect.any(Object), 12345);
    });

    it('should call postTenableSolutionAssets with correct solutionId', () => {
      component.getAffectedHosts(mockSolution);
      expect(mockIntegrationService.postTenableSolutionAssets).toHaveBeenCalledWith(expect.any(Object), 12345);
    });

    it('should call postTenableSolutionAssets with correct params structure', () => {
      component.getAffectedHosts(mockSolution);
      const callArg = mockIntegrationService.postTenableSolutionAssets.mock.calls[0][0];
    ...
    it('should set loadingAffectedHosts to true before request', () => {
      ...
      mockIntegrationService.postTenableSolutionAssets.mockReturnValue(of(mockSolutionAssetsResponse));
      component.getAffectedHosts(mockSolution);
    ...
    it('should call messageService.add on postTenableSolutionAssets error', () => {
      mockIntegrationService.postTenableSolutionAssets.mockReturnValue(throwError(() => new Error('Assets error')));
      component.getAffectedHosts(mockSolution);
      expect(mockMessageService.add).toHaveBeenCalledWith(expect.objectContaining({ severity: 'error', summary: 'Error' }));
    });
    ...
    it('should parse solutionId correctly from solutionID string', () => {
      ...
      expect(mockIntegrationService.postTenableSolutionAssets).toHaveBeenCalledWith(expect.any(Object), 99999);
    });
  });
  ...
  describe('dialog generation guard', () => {
    ...
    it('ignores a late emission from an earlier solution after a newer one was opened', () => {
      ...
      mockIntegrationService.postTenableSolutionAssets.mockReturnValueOnce(firstHosts.asObservable()).mockReturnValueOnce(secondHosts.asObservable());
      mockIntegrationService.postTenableSolutionVuln.mockReturnValue(of(vulns('1')));
    ...
    it('ignores a late vuln-details emission from an earlier solution', () => {
      ...
      mockIntegrationService.postTenableSolutionAssets.mockReturnValue(of(hosts('X')));
      mockIntegrationService.postTenableSolutionVuln.mockReturnValueOnce(firstVulns.asObservable()).mockReturnValueOnce(secondVulns.asObservable());
    ...
    it('drops emissions that arrive after the dialog was reset', () => {
      ...
      mockIntegrationService.postTenableSolutionAssets.mockReturnValue(gate.asObservable());
      mockIntegrationService.postTenableSolutionVuln.mockReturnValue(of(vulns('1')));
    ...
    it('ignores a late error from an earlier solution', () => {
      ...
      mockIntegrationService.postTenableSolutionAssets.mockReturnValueOnce(firstHosts.asObservable()).mockReturnValueOnce(of(hosts('SECOND')));
      mockIntegrationService.postTenableSolutionVuln.mockReturnValue(of(vulns('1')));
  ...
  describe('getVulnDetails', () => {
    ...
    it('should call postTenableSolutionVuln with correct params structure', () => {
      component.getVulnDetails(12345);
      const callArg = mockIntegrationService.postTenableSolutionVuln.mock.calls[0][0];
    ...
    it('should set loadingVulnDetails to true before request', () => {
      ...
      mockIntegrationService.postTenableSolutionVuln.mockReturnValue(of(mockSolutionVulnResponse));
      component.getVulnDetails(12345);
    ...
    it('should call messageService.add on error', () => {
      mockIntegrationService.postTenableSolutionVuln.mockReturnValue(throwError(() => new Error('Vuln error')));
      component.getVulnDetails(12345);
      expect(mockMessageService.add).toHaveBeenCalledWith(expect.objectContaining({ severity: 'error', summary: 'Error' }));
    });
