...
describe('TenableFiltersComponent', () => {
  ...
  describe('loadExistingFilters', () => {
    ...
    it('should not call getTenableFilters when collectionId is 0', () => {
      ...
      expect(mockIntegrationService.getTenableFilters).not.toHaveBeenCalled();
    });

    it('should call getTenableFilters with collectionId', () => {
      (component as any).collectionId = () => 1;
      component.loadExistingFilters();
      expect(mockIntegrationService.getTenableFilters).toHaveBeenCalledWith(1);
    });
    ...
    it('should set existingFilters to empty array on error', () => {
      mockIntegrationService.getTenableFilters.mockReturnValue(throwError(() => new Error('fail')));
      (component as any).collectionId = () => 1;
      component.loadExistingFilters();
  ...
  describe('saveCustomFilter', () => {
    ...
    it('should call addTenableFilter when not updating', () => {
      ...
      component.saveCustomFilter();
      expect(mockIntegrationService.addTenableFilter).toHaveBeenCalledWith(1, expect.objectContaining({ filterName: 'New Filter' }));
    });
    ...
    it('should show error on add failure', () => {
      mockIntegrationService.addTenableFilter.mockReturnValue(throwError(() => new Error('fail')));
      component.selectedFilter.set('New Filter');
      component.isUpdating = false;
      component.saveCustomFilter();
    ...
    it('should call updateTenableFilter when isUpdating and canUpdate', () => {
      ...
      component.saveCustomFilter();
      expect(mockIntegrationService.updateTenableFilter).toHaveBeenCalledWith(1, 3, expect.objectContaining({ filterName: 'Existing Filter', filterId: 3 }));
    });
    ...
    it('should show error on update failure', () => {
      mockIntegrationService.updateTenableFilter.mockReturnValue(throwError(() => new Error('fail')));
      component.selectedFilter.set('Existing Filter');
      component.isUpdating = true;
      component.canUpdate = true;
      component.selectedFilterId = 3;
    ...
    it('should match existing filter name case-insensitively', () => {
      ...
      component.isUpdating = false;
      component.saveCustomFilter();
      expect(mockIntegrationService.addTenableFilter).not.toHaveBeenCalled();
    });
    ...
    it('should use label from FilterOption object as filter name', () => {
      ...
      component.isUpdating = false;
      component.saveCustomFilter();
      expect(mockIntegrationService.addTenableFilter).toHaveBeenCalledWith(1, expect.objectContaining({ filterName: 'Option Filter' }));
    });
  });
