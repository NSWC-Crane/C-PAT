...
export class TenableFiltersComponent implements OnInit {
  ...
  loadExistingFilters() {
    ...
    if (collectionId) {
      this.integrationService.getTenableFilters(collectionId).subscribe({
  ...
  saveCustomFilter() {
    ...
    if (this.isUpdating && this.selectedFilterId && this.canUpdate) {
      ...
      this.integrationService.updateTenableFilter(this.collectionId(), this.selectedFilterId, filterData).subscribe({
        next: () => {
          this.messageService.add({
            severity: 'success',
            summary: 'Success',
      ...
      this.integrationService.addTenableFilter(this.collectionId(), filterData).subscribe({
        next: () => {
          this.messageService.add({
            severity: 'success',
            summary: 'Success',
