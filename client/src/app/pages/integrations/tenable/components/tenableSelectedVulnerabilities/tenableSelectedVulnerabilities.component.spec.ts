...
describe('TenableSelectedVulnerabilitiesComponent', () => {
  ...
  describe('getIAVPluginIDs', () => {
    ...
    it('should call integrationService.getIAVPluginIds', () => {
      component.getIAVPluginIDs();
      expect(mockIntegrationService.getIAVPluginIds).toHaveBeenCalled();
    });
  ...
  describe('getTaskOrderVulnerabilityIds', () => {
    ...
    it('should call getVulnerabilityIdsWithTaskOrderByCollection with selectedCollection', () => {
      ...
      expect(mockIntegrationService.getVulnerabilityIdsWithTaskOrderByCollection).toHaveBeenCalledWith(1);
    });
    ...
    it('should show info message when no data returned', () => {
      mockIntegrationService.getVulnerabilityIdsWithTaskOrderByCollection.mockReturnValue(of([]));
      component.getTaskOrderVulnerabilityIds();
    ...
    it('should show error on failure', () => {
      mockIntegrationService.getVulnerabilityIdsWithTaskOrderByCollection.mockReturnValue(throwError(() => new Error('fail')));
      component.getTaskOrderVulnerabilityIds();
      expect(mockMessageService.add).toHaveBeenCalledWith(expect.objectContaining({ severity: 'error' }));
    });
  ...
  describe('getIAVTaskOrderPluginIDs', () => {
    ...
    it('should call getIAVPluginIds with hasTaskOrder true', () => {
      ...
      expect(mockIntegrationService.getIAVPluginIds).toHaveBeenCalledWith(true);
    });
  ...
  describe('onTaskOrderSourceChange', () => {
    ...
    it('should ignore an in-flight POAM chain after switching to IAV', () => {
      ...
      mockIntegrationService.getVulnerabilityIdsWithTaskOrderByCollection.mockReturnValue(poamIds.asObservable());
      component.getTaskOrderVulnerabilityIds();
  ...
  describe('getApplicableFindings', () => {
    ...
    it('should call postTenableAnalysis with repo filter', () => {
      ...
      const callArgs = mockIntegrationService.postTenableAnalysis.mock.calls[0][0];
    ...
    it('should discard a stale response when a newer request supersedes it', () => {
      ...
      mockIntegrationService.postTenableAnalysis.mockReturnValueOnce(staleAnalysis.asObservable()).mockReturnValueOnce(of(mockAnalysisResponse));
    ...
    it('should not let a stale request clear isLoading while a newer request is in flight', () => {
      ...
      mockIntegrationService.postTenableAnalysis.mockReturnValueOnce(staleAnalysis.asObservable()).mockReturnValueOnce(activeAnalysis.asObservable());
      component.getApplicableFindings('99999');
      component.getApplicableFindings('12345');
    ...
    it('should call getIAVInfoForPlugins with numeric pluginID list', () => {
      ...
      expect(mockIntegrationService.getIAVInfoForPlugins).toHaveBeenCalledWith([12345, 67890]);
    });
  ...
  describe('showDetails', () => {
    ...
    it('should call getTenablePlugin with correct ID', async () => {
      ...
      expect(mockIntegrationService.getTenablePlugin).toHaveBeenCalledWith(12345);
    });
    ...
    it('should reject when getTenablePlugin returns no response', async () => {
      mockIntegrationService.getTenablePlugin.mockReturnValue(of({}));
    ...
    it('should show error and reject when service fails', async () => {
      mockIntegrationService.getTenablePlugin.mockReturnValue(throwError(() => new Error('fail')));
      await expect(component.showDetails({ pluginID: 12345 })).rejects.toBeTruthy();
      expect(mockMessageService.add).toHaveBeenCalledWith(expect.objectContaining({ severity: 'error' }));
    });
  });
