...
describe('TenableVulnerabilitiesComponent', () => {
  ...
  describe('loadSavedFilters', () => {
    it('should call getTenableFilters with selectedCollection', () => {
      ...
      expect(mockIntegrationService.getTenableFilters).toHaveBeenCalledWith(7);
    });
    ...
    it('should build premadeFilterOptions with premade and saved groups', () => {
      component.selectedCollection.set(7);
      mockIntegrationService.getTenableFilters.mockReturnValue(of([{ filterId: 1, filterName: 'My Filter', filter: '{}', createdBy: 'jdoe' }]));
      component.loadSavedFilters();
  ...
  describe('confirmDeleteFilter', () => {
    it('should call deleteTenableFilter with collectionId and filterId', () => {
      ...
      expect(mockIntegrationService.deleteTenableFilter).toHaveBeenCalledWith(7, 5);
    });
    ...
    it('should show error message on failure', () => {
      mockIntegrationService.deleteTenableFilter.mockReturnValue(throwError(() => new Error('fail')));
      component.selectedCollection.set(7);
      component.confirmDeleteFilter(5);
      expect(mockMessageService.add).toHaveBeenCalledWith(expect.objectContaining({ severity: 'error' }));
    });
  ...
  describe('loadAssetOptions', () => {
    ...
    it('should show error on failure', () => {
      mockIntegrationService.getTenableAssetsFilter.mockReturnValue(throwError(() => new Error('fail')));
  ...
  describe('cleanup', () => {
    it('stops applying plugin details after destroy (takeUntilDestroyed)', () => {
      ...
      mockIntegrationService.getTenablePlugin.mockReturnValue(pluginSubject.asObservable());
