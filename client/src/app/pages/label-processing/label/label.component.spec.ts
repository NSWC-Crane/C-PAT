...
describe('LabelComponent', () => {
  ...
  describe('loadPoamsByLabel', () => {
    ...
    it('should clear displayPoams and return when labelId is ADDLABEL', () => {
      ...
      component.displayPoams.set([{ poamId: 1 }]);
  ...
  describe('searchPoams', () => {
    beforeEach(() => {
      component.availablePoams.set(mockPoams);
      component.displayPoams.set([]);
    });
  ...
  describe('addPoamRow', () => {
    ...
    it('should preserve existing rows', () => {
      ...
      component.displayPoams.set([existing]);
      component.addPoamRow();
  ...
  describe('onPoamAdd', () => {
    ...
    it('should call poamService.postPoamLabel for non-duplicate', async () => {
      component.label.set({ labelId: 1, labelName: 'Test' });
      component.displayPoams.set([{ poamId: 99, isNew: false }]);
  ...
  describe('deletePoamFromLabel', () => {
    ...
    it('should call poamService.deletePoamLabel for existing poam', async () => {
      ...
      component.displayPoams.set([{ poamId: 5, isNew: false }]);
